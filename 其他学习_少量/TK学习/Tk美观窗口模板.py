...
labelframe3.grid(row=0, column=1,rowspan=3,sticky=N+S)
...
#输入框布局
entr2_1 = Entry(labelframe2,width=32,textvariable=smtp_var, state="disable")#state='disable'参数为 不可更改.
entr2_1.grid(row=1, column=0)
...
entr2_4 = Entry(labelframe2,width=32,textvariable=title_var,state="disable")
entr2_4.grid(row=7, column=0)
entr2_5 = Entry(labelframe2,width=32,textvariable=title_var,state="disable")
entr2_5.grid(row=9, column=0)
entr2_6 = Entry(labelframe2,width=32,textvariable=title_var,state="disable")
...
# 新加pyechart绘图
from 浏览器窗口嵌入Tk import embed_browser_thread

frame1 = Frame(labelframe3, bg='white',width=400)
